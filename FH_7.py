...
def realpath_demo(file_name):
    ...
    filepath = os.path.realpath(file_name, strict=True)
    print("Path : ", filepath)
...
def realpath_samedemo(path1,path2):
    import os
    # construct a path representing the file in the current directory;
    # It is an abstract path- representing existing or non-exsiting file
    filepath1 = os.path.realpath(path1, strict=False)
    filepath2 = os.path.realpath(path2, strict=False)
    is_same = os.path.samefile(filepath1,filepath2)
    print(f"Are both the paths representing same file ? {is_same}")
...
if __name__ == '__main__':
    ...
    # realpath_demo("d:/temp/abc.txt")
    #realpath_samedemo("d:/temp/abc.txt","d:/temp/company/../abc.txt")
    ...
    # check_if_file_dir_link("mydell")        # Link to Directory  on another drive
    # check_if_file_dir_link("ca.lnk")        # Link to a File in current directory
    # check_if_file_dir_link("myproj.lnk")      # Link to file in another directory
